    ...
    <div class="mb-7">
      <div class="bgImg d-flex jc-center" id="header">
        <div class="text-white d-flex jc-center ai-center">
          <span class="jc-center">        
            <p class="home-text">你好，欢迎来到HXY的个人博客</p>
            <!-- <p>前端程序员，技术追求者</p>
            <p>MyVueBlog</p>
            <P>将JavaScript进行到底的小巧博客系统</P> -->
          </span>            
        </div>
...
.bgImg {
  background-image: url('../assets/images/denis-degioanni-9wH624ALFQA-unsplash.jpg');
  width: 100%;
  height: 100vh;
  ...
  .home-text {
    ...
    white-space: nowrap;
    animation: typing 1s steps(14, end), infinite;
    overflow: hidden;
  }
  .describe{
    align-content: center;
...
@media screen and (max-width: 59.0769rem) {
  .shouye-text {
